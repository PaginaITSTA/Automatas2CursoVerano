...
public class GUIAFD extends javax.swing.JFrame {
    ...
    private ArrayList<String> listaTokens, listaErroresLexicos;
    ...
    private void initComponents() {
        ...
        jMenuItem5.setText("Ejecutar Analisis Lexico");
        ...
        jMenuItem6.setText("Ejecutar Analisi sintactico");
    ...
    private void ejecutarCodigo(String texto) {
        analizador = new analisisLexico(texto);

        analizador.estadoInicial();
        ...
        jTextArea2.append("************* Lista de tokens obtenidos ***************\n\n");
        ...
        listaErroresLexicos = analizador.getListaErroresLexicos();

        if (listaErroresLexicos.size() > 0) {
            jTextArea2.append("\n\n************* Lista de errores obtenidos ***************\n\n");
            int contadorTemporal = 0;
            while (cont < listaErroresLexicos.size()) {
                jTextArea2.append(" -> " + listaErroresLexicos.get(cont) + "\n");
                contadorTemporal++;
            }
        }
